              ...
              <div className="flex justify-between w-full">
                <div className="flex items-center">
                  <Link to="/">
                    <h1 className="text-2xl font-medium">
                      Ibram <span className="text-red-700">Farhani</span>
                    </h1>
                  </Link>
                </div>
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      isActive
                        ? "border-red-500 dark:bg-black dark:text-white h-full inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
